...
router = APIRouter(prefix="/api/gap-no-recommendsources-crossdocument-discovery", tags=["gap-no-recommendsources-crossdocument-discovery"])

FEATURE_SLUG = "no-recommendsources-crossdocument-discovery"
FEATURE_TITLE = "No /recommend-sources cross-document discovery"
