...
router = APIRouter(prefix="/api/gap-no-audit-log-of-who-queried-what", tags=["gap-no-audit-log-of-who-queried-what"])

FEATURE_SLUG = "no-audit-log-of-who-queried-what"
FEATURE_TITLE = "No audit log of who queried what"
