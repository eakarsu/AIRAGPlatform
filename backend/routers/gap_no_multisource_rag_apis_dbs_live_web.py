...
router = APIRouter(prefix="/api/gap-no-multisource-rag-apis-dbs-live-web", tags=["gap-no-multisource-rag-apis-dbs-live-web"])

FEATURE_SLUG = "no-multisource-rag-apis-dbs-live-web"
FEATURE_TITLE = "No multi-source RAG (APIs, DBs, live web)"
