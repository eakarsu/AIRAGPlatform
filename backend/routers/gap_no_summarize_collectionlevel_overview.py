...
router = APIRouter(prefix="/api/gap-no-summarize-collectionlevel-overview", tags=["gap-no-summarize-collectionlevel-overview"])

FEATURE_SLUG = "no-summarize-collectionlevel-overview"
FEATURE_TITLE = "No /summarize collection-level overview"
