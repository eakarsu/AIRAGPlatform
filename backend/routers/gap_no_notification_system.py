...
router = APIRouter(prefix="/api/gap-no-notification-system", tags=["gap-no-notification-system"])

FEATURE_SLUG = "no-notification-system"
FEATURE_TITLE = "No notification system"
