...
router = APIRouter(prefix="/api/gap-no-teamlevel-access-control-role-permissions", tags=["gap-no-teamlevel-access-control-role-permissions"])

FEATURE_SLUG = "no-teamlevel-access-control-role-permissions"
FEATURE_TITLE = "No team-level access control / role permissions"
