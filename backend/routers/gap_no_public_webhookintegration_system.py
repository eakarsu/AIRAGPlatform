...
router = APIRouter(prefix="/api/gap-no-public-webhookintegration-system", tags=["gap-no-public-webhookintegration-system"])

FEATURE_SLUG = "no-public-webhookintegration-system"
FEATURE_TITLE = "No public webhook/integration system"
