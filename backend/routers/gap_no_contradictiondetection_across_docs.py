...
router = APIRouter(prefix="/api/gap-no-contradictiondetection-across-docs", tags=["gap-no-contradictiondetection-across-docs"])

FEATURE_SLUG = "no-contradictiondetection-across-docs"
FEATURE_TITLE = "No contradiction-detection across docs"
