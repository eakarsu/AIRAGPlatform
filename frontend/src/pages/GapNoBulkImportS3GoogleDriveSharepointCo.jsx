...
export default function GapNoBulkImportS3GoogleDriveSharepointCo() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-bulk-import-s3-google-drive-sharepoint-co', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No bulk import (S3, Google Drive, SharePoint connectors)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIRAGPlatform - Gap feature</p>
